...
AIC(mod,modC,modR,modC_R,modCR, modCR_c, modCR_S_c, modCR_c_cS, modCR_S_c_cS, modCR_SR_c_cS, modCR_SR_c_cSR) %>% rownames_to_column() %>% arrange(AIC)
...
modBKT <- bam(observedLength ~ cohort * river + factor(salmon01) +
               s(ydayCumul, bs = 'cr') +
               s(ydayCumul, bs = 'cr', k = kIn, by = cohortOrdered) +
               s(ydayCumul, bs = 'cr', k = kIn,  by = riverOrdered) +
               s(ydayCumul, bs = 'cr', k = kIn, by = cohortRiverOrdered) +
...
modBNT <- bam(observedLength ~ cohort * river + factor(salmon01) +
               s(ydayCumul, bs = 'cr') +
               s(ydayCumul, bs = 'cr', k = kIn, by = cohortOrdered) +
               s(ydayCumul, bs = 'cr', k = kIn,  by = riverOrdered) +
               s(ydayCumul, bs = 'cr', k = kIn, by = cohortRiverOrdered) +
