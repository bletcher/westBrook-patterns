...
ggsave('./figures/cohortStrengthEffect.png', width = 11, height = 8, units='in')
#
...
ggplot(predGrid2Both %>% 
         filter(salmon01 ==0, cohortStrengthScaled == 0, cohort == 2006, cohortStrengthScaled == 0),
...
ggsave('./figures/ydayCumulAcrossSppByRiver.png', width = 11, height = 8, units='in')
